...
| `debug_http`                                     | boolean                                                           | Enable logging of raw HTTP requests and responses for model calls (use with `debug_http_output`).                               |
| `debug_http_output`                              | string (path)                                                     | Write raw HTTP requests and responses to the given file (append mode).                                                          |
